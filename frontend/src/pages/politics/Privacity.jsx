...
const Privacity = () => {
    ...
    useEffect(() => {
        document.title = "Política de Privacidad - IDEE Almonte";
    }, [])
        ...
        <Container fluid className="my-3 position-relative" style={{ paddingLeft: 0, paddingRight: 0 }}>
            ...
            <Row className="justify-content-center">
                ...
                <Col md="10" className="mb-3">
                    ...
                    Nuestro delegado de protección de datos es <strong>AUDIDAT 3.0, S.L.</strong>, y puede contactarse a través  
                    de <a href="mailto:dpd@audidat.com"><strong>dpd@audidat.com</strong></a> para dudas, reclamaciones o sugerencias.
                </Col>

                <Col md="10" className="mb-3">
                    <h4 className="mb-2"><strong>Uso de los datos</strong></h4>
                    Sus datos personales se usarán para atender peticiones relacionadas con el <strong>IDEE de Almonte</strong> y sólo el <strong>personal autorizado de la entidad</strong> tendrá acceso.<br />
